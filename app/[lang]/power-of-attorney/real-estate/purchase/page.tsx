...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.poain30.ae/${lang}/power-of-attorney/real-estate/purchase/`,
      languages: {
        ...Object.fromEntries(
        LANGS.map((l) => [HREFLANG_MAP[l], `https://www.poain30.ae/${l}/power-of-attorney/real-estate/purchase/`])
      ),
        'x-default': `https://www.poain30.ae/en/power-of-attorney/real-estate/purchase/`,
      } } }
}
...
export default async function Page({ params }: Props) {
  ...
  return (
    <>
      <ServicePage
        path={'/power-of-attorney/real-estate/purchase'}
        lang={lang}
        title={seo?.h1}
        ...
        breadcrumb={[
          ...
          { label: lang === 'ar' ? 'وكالة شراء عقار' : 'Purchase POA', href: '/power-of-attorney/real-estate/purchase' },
        ]}
        relatedServices={[
